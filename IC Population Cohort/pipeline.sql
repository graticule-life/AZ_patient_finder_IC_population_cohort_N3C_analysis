...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.dde8e8ea-7ec2-4db6-8497-7b282fa2290c"),
    IC_Population_aged60_or_above=Input(rid="ri.foundry.main.dataset.23991813-0ec2-42f7-86f6-0c2274ce2e2d"),
...
FROM 
    IC_Population_aged60_or_above IC
INNER JOIN 
    person P ON IC.person_id = P.person_id
LEFT JOIN 
